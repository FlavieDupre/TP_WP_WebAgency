...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header" role="banner">
	    <div class="header-t">
          ...
          <a href="http://localhost/BlablaWeb/contact/" title="Besoin de communiquer ? Contactez-nous !">
              <img src=" <?php echo get_template_directory_uri(); ?>/images/visuel_contact.png" width="1140">
          </a>
        </div>
    			<?php 
